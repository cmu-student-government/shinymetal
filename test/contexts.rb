module Contexts
  ...
  #Comments
  def create_comments
    @angrycomment = FactoryGirl.create(:comment, comment_user: @leela, user_key: @bender_key_awaiting_conf_approved, is_private: true)
    @happycomment = FactoryGirl.create(:comment, comment_user: @fry, user_key: @bender_key_awaiting_conf_approved, message: "I love APIs so much", is_private: false)
